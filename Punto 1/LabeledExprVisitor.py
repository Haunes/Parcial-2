...
class LabeledExprVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by LabeledExprParser#imagLitWithInt.
    def visitImagLitWithInt(self, ctx:LabeledExprParser.ImagLitWithIntContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LabeledExprParser#imagLit.
    def visitImagLit(self, ctx:LabeledExprParser.ImagLitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LabeledExprParser#complexLit.
    def visitComplexLit(self, ctx:LabeledExprParser.ComplexLitContext):
        return self.visitChildren(ctx)
